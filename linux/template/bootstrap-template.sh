...
curl -sL https://raw.githubusercontent.com/theprotos/cookbooks-generic/development/scripts/linux.sh | sudo bash -s apply linux-vagrant.json,linux-packages.json,linux-docker.json development
